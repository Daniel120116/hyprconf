...
# Advanced Hyprland Installation Script by Daniel120116 (:https://github.com/Daniel120116:)
...
git clone --depth=1 https://github.com/Daniel120116/hyprconf.git "$HOME/.cache/hyprconf" &> /dev/null
